<x-layout>
            ...
            <form action="/posts">
                ...
                <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                    <div class="relative w-full">
                        ...
                        <input class="block p-3 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:rounded-none sm:rounded-l-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search for artycle" type="search" id="search" name="search" autocomplete="off">
                    </div>
                    <div>
    ...
    <div class="my-4 py-4 px-4 mx-auto max-w-screen-xl lg:py-5 lg:px-0">
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            @empty
            <div>
                <p class="font-semibold text-xl my-4">Artcile Not Found</p>
